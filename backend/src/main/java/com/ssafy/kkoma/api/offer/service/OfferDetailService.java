...
public class OfferDetailService {
    ...
    public SendOfferResponse createOfferDetail(Long offerId, List<OfferTimeRequest> offerTimeRequestList){
        ...
        return SendOfferResponse.builder().offerId(offerId).build();
    }
